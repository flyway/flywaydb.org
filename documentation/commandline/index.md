...
<table class="table">
<tr><td><i class="fa fa-windows"></i> Windows</td><td><a onclick="downloadThanks()" class="btn btn-primary btn-download" href="https://repo1.maven.org/maven2/org/flywaydb/flyway-commandline/{{site.flywayVersion}}/flyway-commandline-{{site.flywayVersion}}-windows-x64.zip"><i class="fa fa-download"></i> flyway-commandline-{{site.flywayVersion}}-windows-x64.zip</a></td></tr>
<tr><td><i class="fa fa-apple"></i> macOS</td><td><a onclick="downloadThanks()" class="btn btn-primary btn-download" href="https://repo1.maven.org/maven2/org/flywaydb/flyway-commandline/{{site.flywayVersion}}/flyway-commandline-{{site.flywayVersion}}-macosx-x64.tar.gz"><i class="fa fa-download"></i> flyway-commandline-{{site.flywayVersion}}-macosx-x64.tar.gz</a></td></tr>
<tr><td><i class="fa fa-linux"></i> Linux</td><td><a onclick="downloadThanks()" class="btn btn-primary btn-download" href="https://repo1.maven.org/maven2/org/flywaydb/flyway-commandline/{{site.flywayVersion}}/flyway-commandline-{{site.flywayVersion}}-linux-x64.tar.gz"><i class="fa fa-download"></i> flyway-commandline-{{site.flywayVersion}}-linux-x64.tar.gz</a></td></tr>
...
<tr><td>All platforms</td><td>            <a onclick="downloadThanks()" href="https://repo1.maven.org/maven2/org/flywaydb/flyway-commandline/{{site.flywayVersion}}/flyway-commandline-{{site.flywayVersion}}.zip">flyway-commandline-{{site.flywayVersion}}.zip
                                              (requires at Java 8 JRE)</a><br/>
                                          <a onclick="downloadThanks()" href="https://repo1.maven.org/maven2/org/flywaydb/flyway-commandline/{{site.flywayVersion}}/flyway-commandline-{{site.flywayVersion}}.tar.gz">flyway-commandline-{{site.flywayVersion}}.tar.gz
                                              (requires at Java 8 without JRE)</a>
<tr><td>Sources</td><td><a onclick="downloadThanks()" href="https://repo1.maven.org/maven2/org/flywaydb/flyway-commandline/{{site.flywayVersion}}/flyway-commandline-{{site.flywayVersion}}-sources.jar">flyway-commandline-{{site.flywayVersion}}-sources.jar</a></td></tr>
</td></tr>
</table>
