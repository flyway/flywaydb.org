...
<table class="table table-bordered table-hover">
    ...
    <tr>
        ...
        <td>NO</td>
        <td><i>none</i></td>
        <td>Comma-sparated list of fully qualified class names of <a href="/documentation/errorhandlers">Error Handlers</a> for errors and warnings that occur during
