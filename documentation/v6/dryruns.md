...
[schema history table](/documentation/v6/migrations#schema-history-table), ensuring that all schema changes are tracked the usual way.
...
When using the Flyway [command-line tool](/documentation/v6/commandline), [Maven plugin](/documentation/v6/maven) or
[Gradle plugin](/documentation/v6/gradle), a SQL file contained the output of the dry run can be configured using the 
[`flyway.dryRunOutput`](/documentation/v6/commandline/migrate#dryRunOutput) property.
...
<p class="next-steps">
    <a class="btn btn-primary" href="/documentation/v6/command/migrate">Migrate <i class="fa fa-arrow-right"></i></a>
</p>