...
<a href="/documentation/v6/command/repair"><img src="/assets/balsamiq/command-repair.png" alt="repair"></a>
...
<p class="next-steps">
    <a class="btn btn-primary" href="/documentation/v6/plugins">Community Plugins <i class="fa fa-arrow-right"></i></a>
</p>