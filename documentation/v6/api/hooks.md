...
The first one is the the most common one: [Java-based Migrations](/documentation/v6/migrations#java-based-migrations)
...
Building upon that are the Java-based [Callbacks](/documentation/v6/callbacks)
when you need more power or flexibility in a Callback than SQL can offer you.

They can be created by implementing the [**Callback**](/documentation/v6/api/javadoc/org/flywaydb/core/api/callback/Callback)
interface:
...
The `event` argument tells you which [`Event`](/documentation/v6/api/javadoc/org/flywaydb/core/api/callback/Event) 
...
implement your own [`MigrationResolver`](/documentation/v6/api/javadoc/org/flywaydb/core/api/resolver/MigrationResolver)
coupled with a custom [`MigrationExecutor`](/documentation/v6/api/javadoc/org/flywaydb/core/api/executor/MigrationExecutor).
...
<p class="next-steps">
    <a class="btn btn-primary" href="/documentation/v6/api/javadoc">API: Javadoc <i class="fa fa-arrow-right"></i></a>
</p>