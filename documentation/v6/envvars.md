...
The Flyway [command-line tool](/documentation/v6/commandline), [Maven plugin](/documentation/v6/maven) and
[Gradle plugin](/documentation/v6/gradle) support loading configuration via environment variables.
...
<table class="table table-bordered table-hover">
    ...
    <tr id="FLYWAY_RESOLVERS">
        ...
        <td>Comma-separated list of fully qualified class names of custom
            <a href="/documentation/v6/api/javadoc/org/flywaydb/core/api/resolver/MigrationResolver">MigrationResolver</a>
    ...
    <tr id="FLYWAY_CALLBACKS">
        ...
        <td>Comma-separated list of fully qualified class names of
            <a href="/documentation/v6/api/javadoc/org/flywaydb/core/api/callback/Callback">Callback</a>
    ...
    <tr id="FLYWAY_ORACLE_SQLPLUS">
        ...
        <td>Enable Flyway's support for <a href="/documentation/v6/database/oracle#sqlplus-commands">Oracle SQL*Plus commands</a></td>
    </tr>
...
<p class="next-steps">
    <a class="btn btn-primary" href="/documentation/v6/ssl">SSL support <i class="fa fa-arrow-right"></i></a>
</p>
