...
[Config files](/documentation/v6/configfiles) are supported by the Flyway Maven plugin. If you are not familiar with them,
...
<p class="next-steps">
    <a class="btn btn-primary" href="/documentation/v6/maven/migrate">Maven: migrate <i class="fa fa-arrow-right"></i></a>
</p>
