...
- [Standard SQL syntax](/documentation/v6/migrations#sql-based-migrations#syntax)
- DB2 SQL-PL
- Terminator changes
...
<p class="next-steps">
    <a class="btn btn-primary" href="/documentation/v6/database/mysql">MySQL<i class="fa fa-arrow-right"></i></a>
</p>