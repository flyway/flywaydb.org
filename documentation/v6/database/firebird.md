...
## SQL Script Syntax
 ...
 - [Standard SQL syntax](/documentation/v6/migrations#syntax)
...
database and run the migration with exclusive access.
 ...
 <p class="next-steps">
    <a class="btn btn-primary" href="/documentation/v6/existing">Existing database setup <i class="fa fa-arrow-right"></i></a>
</p>