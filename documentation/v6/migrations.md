...
By default both versioned and repeatable migrations can be written either in **[SQL](/documentation/v6/migrations#sql-based-migrations)**
or in **[Java](/documentation/v6/migrations#java-based-migrations)** and can consist of multiple statements.
...
- **Prefix**: `V` for versioned ([configurable](/documentation/v6/commandline/migrate#sqlMigrationPrefix)),
`U` for undo ([configurable](/documentation/v6/commandline/migrate#undoSqlMigrationPrefix)) and
`R` for repeatable migrations ([configurable](/documentation/v6/commandline/migrate#repeatableSqlMigrationPrefix))
- **Version**: Version with dots or underscores separate as many parts as you like (Not for repeatable migrations)
- **Separator**: `__` (two underscores) ([configurable](/documentation/v6/commandline/migrate#sqlMigrationSeparator))
- **Description**: Underscores or spaces separate the words
- **Suffix**: `.sql` ([configurable](/documentation/v6/commandline/migrate#sqlMigrationSuffixes))
...
Migrations reside in one or more directories referenced by the **[`locations`](/documentation/v6/commandline/migrate#locations)**
property.
...
Once you have configured the [`locations`](/documentation/v6/commandline/migrate#locations) you want to use, Flyway will
...
Additionally in the case of Oracle, Flyway also supports [SQL*Plus commands](/documentation/v6/database/oracle#sqlplus-commands).
...
See [Placeholders](/documentation/v6/placeholders).
...
[`JavaMigration`](/documentation/v6/api/javadoc/org/flywaydb/core/api/migration/JavaMigration) interface. Most users
however should inherit from the convenience class [`BaseJavaMigration`](/documentation/v6/api/javadoc/org/flywaydb/core/api/migration/BaseJavaMigration)
...
[`JavaMigration`](/documentation/v6/api/javadoc/org/flywaydb/core/api/migration/JavaMigration) interface directly.
...
[`locations`](/documentation/v6/commandline/migrate#locations) property.
...
within a single transaction by setting the [`group`](/documentation/v6/commandline/migrate#group) property to `true`.
...
this by setting the [`mixed`](/documentation/v6/commandline/migrate#mixed) property to `true`. Note that this is only
...
For SQL migrations, you can specify the script configuration property `executeInTransaction`. See [Script config](/documentation/v6/scriptconfigfiles).
### Important Note
...
You may also need to run [repair](/documentation/v6/command/repair) to remove the failed migration entry from the [schema
...
To prevent Flyway from displaying query results, set the configuration option [`outputQueryResults`](/documentation/v6/commandline/migrate#outputQueryResults) to `false`.
