...
One or more Errors Overrides can be configured using the [`errorOverrides`](/documentation/v6/commandline/migrate#errorOverrides)
...
following the execution of a statement by implementing a Java-based [callback](/documentation/v6/callbacks) which listens
...
<p class="next-steps">
    <a class="btn btn-primary" href="/documentation/v6/dryruns">Dry Runs <i class="fa fa-arrow-right"></i></a>
</p>