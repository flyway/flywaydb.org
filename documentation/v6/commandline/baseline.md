...
<a href="/documentation/v6/command/baseline"><img src="/assets/balsamiq/command-baseline.png" alt="baseline"></a>
...
<p class="next-steps">
    <a class="btn btn-primary" href="/documentation/v6/commandline/repair">Command-line: repair <i class="fa fa-arrow-right"></i></a>
</p>