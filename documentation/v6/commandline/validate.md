...
<a href="/documentation/v6/command/validate"><img src="/assets/balsamiq/command-validate.png" alt="validate"></a>
...
<p class="next-steps">
    <a class="btn btn-primary" href="/documentation/v6/commandline/undo">Command-line: undo <i class="fa fa-arrow-right"></i></a>
</p>
