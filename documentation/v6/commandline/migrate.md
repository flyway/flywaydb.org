...
<a href="/documentation/v6/command/migrate"><img src="/assets/balsamiq/command-migrate.png" alt="migrate"></a>
...
<p class="next-steps">
    <a class="btn btn-primary" href="/documentation/v6/commandline/clean">Command-line: clean <i class="fa fa-arrow-right"></i></a>
</p>