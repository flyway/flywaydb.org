...
<a href="/documentation/v6/command/info"><img src="/assets/balsamiq/command-info.png" alt="info"></a>
...
<p class="next-steps">
    <a class="btn btn-primary" href="/documentation/v6/commandline/validate">Command-line: validate <i class="fa fa-arrow-right"></i></a>
</p>