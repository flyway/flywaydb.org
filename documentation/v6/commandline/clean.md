...
<a href="/documentation/v6/command/clean"><img src="/assets/balsamiq/command-clean.png" alt="clean"></a>
...
<p class="next-steps">
    <a class="btn btn-primary" href="/documentation/v6/commandline/info">Command-line: info <i class="fa fa-arrow-right"></i></a>
</p>