...
[Undoes](/documentation/v6/command/undo) the most recently applied versioned migration.

<a href="/documentation/v6/command/undo"><img src="/assets/balsamiq/command-undo.png" alt="undo"></a>
...
<p class="next-steps">
    <a class="btn btn-primary" href="/documentation/v6/commandline/baseline">Command-line: baseline <i class="fa fa-arrow-right"></i></a>
</p>