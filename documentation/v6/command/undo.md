...
include the older state that one desires and then reapplied using [migrate](/documentation/v6/command/migrate).
...
<p class="next-steps">
    <a class="btn btn-primary" href="/documentation/v6/command/baseline">Baseline <i class="fa fa-arrow-right"></i></a>
</p>