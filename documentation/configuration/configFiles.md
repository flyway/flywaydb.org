...
Additionally you can make Flyway load other configurations using the [configFiles](/documentation/configuration/parameters/configFiles) configuration parameter.
...
# If set to true, default built-in resolvers (sql and jdbc) are skipped and only custom resolvers as
