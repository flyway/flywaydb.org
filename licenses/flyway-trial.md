...
These rights are granted without any territorial limitation. The license is valid for the duration of thirty days as of the initial acquisition by the Licensee. The rights are granted as non-exclusive rights, which may be exercised in any hardware and software environment of Licensee, for all currently known types of use; they are limited to 10 production database schemas.
...
The Licensee is not granted any rights to the source code of the software.
...
## 10. Agreement Term
The license is valid for the duration of thirty days as of the initial acquisition by the Licensee.
